...
async function listVariables(_args, ctx) {
    const variables = await ghJson(["variable", "list", "--json", "name,value,updatedAt"], ctx);
...
async function setVariable(args, ctx) {
...
async function deleteVariable(args, ctx) {
...
export async function variableCommand(args, ctx) {
    const sub = args[0];
