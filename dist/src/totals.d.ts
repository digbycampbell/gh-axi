 ...
 */
export declare function searchQualifier(key: string, value: string): string;
/**
 ...
 */
export declare function searchQualifiers(key: string, value: string): string[];
/** Map a gh `--state` value onto its search qualifier; `all` has none. */
export declare function stateQualifiers(state: string | undefined): string[];
/**
 ...
 */
export declare function isSearchableMilestone(value: string): boolean;
/**
 ...
 */
export declare function isSearchableValue(value: string): boolean;
/**
 ...
 */
export declare function fetchSearchTotal(qualifiers: string[]): Promise<number | undefined>;
 ...
 */
export declare function fetchRepositoryTotal(ctx: RepoContext, entity: RepositoryEntity, state: string | undefined): Promise<number | undefined>;
 ...
 */
export declare function fetchListTotal(ctx: RepoContext, entity: RepositoryEntity, state: string | undefined, filters: ListFilter[]): Promise<number | undefined>;
